...
- Produce 8 to 12 components. A component is a part of the product a non-engineer could name and care about ("Memo Editor", "Authentication", "Data Storage") — not a single file, not a programming language, not a build tool.
